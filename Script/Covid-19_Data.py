...
print("Para pesquisa por cidade, digite 1 \npara pesquisa por código do IBGE, digite 2")

select = int(input("Digite 1 ou 2: "))
...
url = (
    ...
    + "?search=&epidemiological_week=&is_last=True&order_for_place=&state="
    + state
    + "&city="
    + city
    + "&city_ibge_code="
    + ibge
    + "&place_type=city&last_available_date=&is_last=True&is_repeated=False"
)
data = get(url).json()
...
print(
    "O número de casos confirmados é",
    casos_conf,
    "sendo que são",
    casos_novos,
    "novos.",
...
print(
    "Temos uma taxa de contaminação ",
    taxa_contaminacao,
    "%, com",
    casos_100k,
...
print(
    "O número de mortes confirmados é",
    mortes_conf,
    "sendo que são",
    mortes_novas,
    "novas.",
